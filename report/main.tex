...
\begin{titlepage}
  ...
  \begin{tabular}{@{}ll@{}}
    ...
    \textbf{Date:}       & May 2026 \\[0.6em]
    \textbf{Live Demo:}  & \url{https://financial-app-system-bcffpkdt88dxp8krfjg7pd.streamlit.app/} \\
  \end{tabular}
...
\begin{lstlisting}[caption={Live evaluation output on 50 real financial-qa-10K pairs (evaluation/results/)}, language={}]
{
  "embedding_baseline": {
    "TF-IDF":              {"hit_at_1": 0.940, "hit_at_3": 1.000, "avg_mrr": 0.963},
    "Word2Vec":            {"hit_at_1": 0.640, "hit_at_3": 0.760, "avg_mrr": 0.717},
    "SentenceTransformer": {"hit_at_1": 1.000, "hit_at_3": 1.000, "avg_mrr": 1.000}
  },
  "rag_vs_norag": {
    "No-RAG":         {"avg_keyword_hit_rate": 0.008},
    "Random-Context": {"avg_keyword_hit_rate": 0.133},
    "RAG":            {"avg_keyword_hit_rate": 0.840}
  },
  "embedding_benchmark": {
